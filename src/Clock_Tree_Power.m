...
Leakage = 0;                                               %Leakage power in the clock network


P_45 = P_Tree + P_leaf_pi + P_leaf_filt + P_leaf_GLB + Leakage;   %Total power dissipation (in Watt) from the clock network in 45nm technology node
